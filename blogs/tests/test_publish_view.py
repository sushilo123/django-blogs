...
class PublishViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.url1 = reverse('blogs:publish', kwargs={'uuid': self.post1.uuid})
        self.url2 = reverse('blogs:publish', kwargs={'uuid': self.post2.uuid})
    ...
    def test_author_required(self):
        """
        Tests that normal user can not publish.
        """
    ...
    def test_same_author_required(self):
        """
        Tests that other author cannot publish.
        """
        self.client.force_login(self.author_user)
        response = self.client.get(self.url2)
        self.assertEqual(response.status_code, 403)
    
    def test_published_same_author(self):
        """
        Tests that the post is published when author is correct.
        """
    ...
    def test_404_on_invalid_uuid(self):
        ...
        """
        self.client.force_login(self.author_user)
        response = self.client.get(reverse('blogs:publish', kwargs={'uuid': 'abcdefab-abcd-1234-abcd-1234abcdef56'}))
